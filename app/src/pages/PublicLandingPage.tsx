...
export default function PublicLandingPage() {
  ...
  return (
    <main className="public-landing">
      ...
      <section className="public-landing__about">
        <h2 className="public-landing__about-title">What is ZenOS?</h2>
        <p className="public-landing__about-desc">
          ZenOS is a personal productivity system that helps you connect your calendar, tasks, and goals into one deliberate daily practice.
        </p>
        <ul className="public-landing__about-features">
          <li>Connect Google Calendar &amp; Tasks</li>
          <li>Set themes and track meaningful actions</li>
          <li>AI-powered planning assistant</li>
          <li>Daily notes, gratitude, and reflection</li>
        </ul>
      </section>
      ...
      <section className="public-landing__data-usage">
        ...
        <p className="public-landing__data-usage-desc">
          We request access to your Google account to sync calendar events and tasks with your ZenOS planner. We never share your data with third parties.
        </p>
